...
<ProjectStructuredData
  name="Tilt-Bot - AI Gaming Roast Generator"
  description="An AI-powered gaming roast generator that creates witty, non-toxic comebacks for gamers."
  url="https://www.shivamtaneja.com/projects/tilt-bot"
  tech={["Next.js", "React", "NestJS", "Groq AI", "Prisma"]}
/>

export const metadata = {
  title: "Tilt-Bot - AI Gaming Roast Generator",
  description:
    "An AI-powered gaming roast generator that creates witty, non-toxic comebacks for gamers, using Groq AI to help maintain a positive gaming environment while preserving the fun of competitive banter.",
  keywords: [
    "AI roast generator",
    "gaming comebacks",
  ...
  alternates: {
    canonical: "https://www.shivamtaneja.com/projects/tilt-bot",
  },
};
