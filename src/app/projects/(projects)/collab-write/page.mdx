...
<ProjectStructuredData
  name="CollabWrite"
  description="An open-source, real-time collaborative knowledge-sharing platform inspired by Wikipedia and Notion."
  url="https://www.shivamtaneja.com/projects/collab-write"
  repo="https://github.com/shivam-taneja/CollabWrite"
  tech={["Next.js", "React", "Appwrite", "Tiptap", "Tailwind CSS"]}
/>
...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.shivamtaneja.com/projects/collab-write",
  },
};
