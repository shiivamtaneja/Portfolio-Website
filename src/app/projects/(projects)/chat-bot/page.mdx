...
<ProjectStructuredData
  ...
  description="An AI chatbot integrated into a portfolio website using vector search and LLMs to answer questions about work and experience."
  url="https://www.shivamtaneja.com/projects/chat-bot"
  tech={["Next.js", "React", "MongoDB", "Groq AI", "LangChain", "Vertex AI"]}
/>

export const metadata = {
  title: "AI-Powered Portfolio Chatbot",
  description:
    "An AI chatbot integrated into my portfolio site that uses Groq AI, Vertex AI to generate embeddings and MongoDB vector search to provide smart, contextual answers about my work, skills, and experience in real-time.",
  keywords: [
    "AI chatbot",
    "portfolio chatbot",
    "Groq AI",
...
<Wrapper>
  <article className="flex flex-col gap-6">
    ...
    <SubSection title="About The Project">
      ...
      website content using Vector embeddings, vector search and natural language
      processing.
    </SubSection>
    ...
    <SubSection title="Features">
      - **Natural Conversation**: Engage in natural dialogue with an AI
      representation of me - **Contextual Awareness**: The chatbot maintains
      conversation history to provide coherent responses - **Knowledge Base**: Uses
      vector search to find and reference relevant information from my website -
      **Persistent Chats**: Conversations are stored and can be resumed in future
      sessions - **Responsive UI**: Chat interface works seamlessly across desktop
      and mobile devices - **Fast Response Time**: Optimized for quick responses
    ...
    <SubSection title="Challenges Faced">
      - **Vector Database Integration**: Setting up and optimizing MongoDB's vector
      search capabilities required careful configuration and testing. - **Context
      Management**: Balancing the amount of context (chat history and relevant
      content) sent to the AI model without exceeding token limits was challenging.
      - **Response Optimization**: Tuning the AI model to provide concise yet
      informative responses while maintaining a consistent persona.
    </SubSection>
