...
<ProjectStructuredData
  name="Circle Catcher - The Circle Game"
  description="A browser-based arcade game built with vanilla JavaScript and HTML Canvas."
  url="https://www.shivamtaneja.com/projects/circle-catcher"
  repo="https://github.com/shiivamtaneja/circle-game"
...
export const metadata = {
  ...
  description:
    "Circle Catcher is a fun and addictive game where the player controls a white circle to eat smaller circles, increasing its size while avoiding being eaten by larger circles. Play through three difficulty modes in this simple yet challenging game.",
  keywords: [
    "circle catcher",
    "circle game",
    "browser game",
  ...
  alternates: {
    canonical: "https://www.shivamtaneja.com/projects/circle-catcher",
  },
};
