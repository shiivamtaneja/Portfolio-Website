  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className='-mb-20 md:mb-0 mt-[450px] md:mt-40 lg:mt-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-96 md:h-80 xl:w=[500px] xl:h-[600px]'
      />
